...
DataList = Generator.GeneratePolyData(100,[1,-2,-3,-4],noise=0,normalNoise=True)
DataList = Generator.GenerateBinaryData(100,[1,-2,-3,1],Poly=True,noise=0.3)

test = Radius_Basis_Function_Network.RBF_Network(DataList,4,1,Kernel="Gaussian")

test.ConstructKClusters()
