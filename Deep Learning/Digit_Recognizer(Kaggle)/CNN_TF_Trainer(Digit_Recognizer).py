...
pickle_file = 'D:\\Google Drive\\Deep_Learning_Data\\Data\\Digit Recognizer(Kaggle)\\train.pickle'
...
with tf.Session(graph=graph) as session:
  ...
  while step < num_steps:
    ...
    if (step % 10000 == 0):
        saver.save(session,
                   'D:\\Google Drive\\Deep_Learning_Data\\Model\\Digit Recognizer(Kaggle)\\CNN({},{}x{}x{},{},{}x{},{})\\Saved'.format(
