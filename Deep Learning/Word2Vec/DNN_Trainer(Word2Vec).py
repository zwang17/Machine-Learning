...
print('made:',dictionary['made'])
print('does:',dictionary['does'])
print('did:',dictionary['did'])
...
with tf.Session(graph=graph) as session:
    ...
    saver.save(session,
               'D:\\Google Drive\\Deep_Learning_Data\\Model\\Word2Vec\\DNN({},{})\\Saved'.format(step,embedding_size))
