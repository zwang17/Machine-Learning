...
session = tf.Session()
saver = tf.train.import_meta_graph('C:\\Users\\alien\\Desktop\\Deep_Learning_Data\\model\\Word2Vec\\{}\Saved.meta'.format(model))
saver.restore(session,'C:\\Users\\alien\\Desktop\\Deep_Learning_Data\\model\\Word2Vec\\{}\Saved'.format(model))
